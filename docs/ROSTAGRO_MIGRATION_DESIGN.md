...
> **Исторический design-документ с предварительными гипотезами.** Актуальные решения владельца
> зафиксированы в [ROSTAGRO_PRODUCT_SPEC.md](ROSTAGRO_PRODUCT_SPEC.md). При противоречии действует
> продуктовая спецификация; переносить поведение из этого файла в код без сверки запрещено.
