...
- [ ] Пакет 2 — WorkflowTask, очередь задач, приоритеты и автоматическое назначение.
  Возврат невзятых задач в очередь и обработка незавершённой физической операции
