...
>
> Пакет 10 доставлен на prod: commit `7907c00`, миграция
> `20260806130000_integration_api_s5p10`. В настройках доступен чек-лист готовности
> единственного активного склада; реализован tenant-bound Integration API товаров и заказов.
> На prod интеграция не активирована: `INTEGRATION_API_ENABLED=false`,
> `INTEGRATION_API_TOKEN` и `INTEGRATION_API_ORG_SLUG` не заданы. До включения необходимо
> подготовить реальные справочники, проверить настройки X/R и определить внешний адаптер
> импорта. Товары, отсутствующие во внешней системе, автоматически не удаляются.
